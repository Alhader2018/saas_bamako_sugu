...
<head>
    ...
    <title>Erreur Serveur (500) — BKO SU</title>
...
<body class="h-full antialiased text-[#1F2937] flex items-center justify-center p-4">
    <div class="max-w-md w-full text-center bg-white border border-[#E5E7EB] rounded-lg p-8 shadow-xs">
        ...
        <h1 class="text-lg font-bold text-[#111111] mt-2">Une erreur est survenue</h1>
        <p class="text-xs text-[#6B7280] mt-1.5">
            Notre équipe technique a été notifiée et résout le problème. Veuillez réessayer dans quelques instants.
        </p>
        <div class="mt-6">
