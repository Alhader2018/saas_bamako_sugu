                        ...
                        <div class="space-y-2.5">
                            ...
                            >
                                ...
                                <div class="flex-1 text-xs">
                                    ...
                                    <p class="text-[#6B7280] mt-0.5">Paiement via votre numéro Orange Money (+223).</p>
                            ...
                            >
                                ...
                                <div class="flex-1 text-xs">
                                    ...
                                    <p class="text-[#6B7280] mt-0.5">Règlement au coursier lors de la remise de votre colis.</p>
                                </div>
                            </label>
                        </div>
                    </div>
